...
5. [x] Comparison tests pass (when uwot package available)
...
When uwot package is available, comparison tests verify:
- UMAP quality metrics: trustworthiness difference < 0.1
- Both implementations achieve > 0.85 trustworthiness
- Distance correlation > 0.8 between embeddings
- All RNG types supported: pcg, tausworthe, deterministic
- Model save/load produces consistent results
