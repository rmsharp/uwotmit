...
![UMAP projection of Ames housing features colored by sale price.
Similar houses (in terms of the 16 numeric features) are positioned near
each other.](categorical-umap-01_files/figure-html/umap-viz-price-1.png)
...
distinct clusters while others
overlap.](categorical-umap-01_files/figure-html/umap-viz-neighborhood-1.png)
...
structure, higher values capture more global
patterns.](categorical-umap-01_files/figure-html/param-comparison-1.png)
...
transformed using the model fitted on training
data.](categorical-umap-01_files/figure-html/train-test-viz-1.png)
...
potentially creating better separation for prediction
tasks.](categorical-umap-01_files/figure-html/supervised-umap-1.png)
